      ...
      <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-2 gap-2">
        <div className="flex items-start gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0 space-y-1">
            <h3 className="text-lg font-semibold text-card-foreground break-words line-clamp-2" title={meeting.title}>
              {meeting.title}
            </h3>
            <p className="text-sm text-muted-foreground truncate" title={meeting.fileName}>{meeting.fileName}</p>
          </div>
        </div>
        <Button
          variant="ghost"
